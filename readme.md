...
Download and run the Whatsapp.app file from the [latest release v0.1.5](https://github.com/bcalik/Whatsapp-Desktop/releases/download/v0.1.5/Whatsapp.app.zip).
